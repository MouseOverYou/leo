...
function ChangeMaterialProperties() {
    ...
    var blueBay =new BABYLON.Color3.FromHexString("#EC0928");
    var lightGrayBay = new BABYLON.Color3.FromHexString("#eeeeee");
    var darkGrayBay = new BABYLON.Color3.FromHexString("#a3a3a3");
    ...
    scene.getMaterialByName("nordsonMat").metallic = 0.4
    scene.getMaterialByName("nordsonMat").roughness = 0.15
